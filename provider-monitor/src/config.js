...
function loadConfig(env = process.env) {
  ...
  const config = {
    ...
    rawSnapshotRetentionDays: parseInteger(env.PROVIDER_MONITOR_RAW_SNAPSHOT_RETENTION_DAYS, 30, 1, 3650),
    snapshotRetentionDays: parseInteger(env.PROVIDER_MONITOR_SNAPSHOT_RETENTION_DAYS, 180, 1, 3650),
    jobRetentionDays: parseInteger(env.PROVIDER_MONITOR_JOB_RETENTION_DAYS, 90, 1, 3650),
    auditRetentionDays: parseInteger(env.PROVIDER_MONITOR_AUDIT_RETENTION_DAYS, 365, 1, 3650),
    notificationRetentionDays: parseInteger(env.PROVIDER_MONITOR_NOTIFICATION_RETENTION_DAYS, 180, 1, 3650),
    assetChangeRetentionDays: parseInteger(env.PROVIDER_MONITOR_ASSET_CHANGE_RETENTION_DAYS, 180, 1, 3650),
